...
Usage:
    python tests/golden/multi_target_spotlight/plot.py [--show]
...
def main():
    ...
    print(f"  Saved: plot2_focused_image.png")
    ...
    print(f"  Saved: plot3_range_cut.png")
    ...
    print(f"  Saved: plot4_relative_amplitude.png")
