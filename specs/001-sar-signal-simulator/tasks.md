...
- [ ] T007 Implement AlgorithmRegistry (generic registry for all plugin types) in `pySimSAR/algorithms/registry.py`
- [ ] T008 [P] Implement WaveformRegistry and PhaseNoiseRegistry in `pySimSAR/waveforms/registry.py`
- [ ] T009 [P] Implement ClutterModelRegistry in `pySimSAR/clutter/registry.py`
- [ ] T010 [P] Implement SensorErrorModelRegistry in `pySimSAR/sensors/registry.py`
- [ ] T011 Implement Waveform ABC (generate, range_compress, duty_cycle, bandwidth, window, phase_noise) in `pySimSAR/waveforms/base.py`
- [ ] T012 [P] Implement PhaseNoiseModel ABC in `pySimSAR/waveforms/phase_noise.py`
- [ ] T013 [P] Implement ClutterModel ABC in `pySimSAR/clutter/base.py`
- [ ] T014 [P] Implement GPSErrorModel ABC in `pySimSAR/sensors/gps.py`
- [ ] T015 [P] Implement IMUErrorModel ABC in `pySimSAR/sensors/imu.py`
- [ ] T016 Implement ImageFormationAlgorithm ABC (process, range_compress, azimuth_compress, supported_modes) in `pySimSAR/algorithms/base.py`
- [ ] T017 [P] Implement MotionCompensationAlgorithm ABC in `pySimSAR/algorithms/base.py`
- [ ] T018 [P] Implement AutofocusAlgorithm ABC (focus, estimate_phase_error) in `pySimSAR/algorithms/base.py`
- [ ] T019 [P] Implement ImageTransformationAlgorithm ABC in `pySimSAR/algorithms/base.py`
- [ ] T020 [P] Implement PolarimetricDecomposition ABC in `pySimSAR/algorithms/base.py`
- [ ] T021 Implement contract tests for Waveform interface in `tests/contract/test_waveform_interface.py`
- [ ] T022 [P] Implement contract tests for all algorithm ABCs (including plugin extensibility test: register a mock algorithm, verify it appears in registry and is callable without modifying existing code — SC-003) in `tests/contract/test_algorithm_interface.py`
...
- [ ] T023 [P] [US1] Unit test for PointTarget and DistributedTarget in `tests/unit/test_scene.py`
- [ ] T024 [P] [US1] Unit test for Radar (carrier_freq, prf, noise params, derived properties) in `tests/unit/test_radar.py`
- [ ] T025 [P] [US1] Unit test for AntennaPattern (2D gain lookup, beamwidth) in `tests/unit/test_radar.py`
- [ ] T026 [P] [US1] Unit test for LFMWaveform (generate, range_compress, duty_cycle derivation) in `tests/unit/test_waveforms.py`
- [ ] T027 [P] [US1] Unit test for FMCWWaveform (ramp types, dechirp, triangle processing) in `tests/unit/test_waveforms.py`
- [ ] T028 [P] [US1] Unit test for CompositePSDPhaseNoise (PSD shaping, generation) in `tests/unit/test_waveforms.py`
- [ ] T029 [P] [US1] Unit test for UniformClutter in `tests/unit/test_scene.py`
- [ ] T030 [P] [US1] Unit test for echo signal computation (single point target phase accuracy) in `tests/unit/test_signal.py`
- [ ] T031 [US1] Integration test for full simulation pipeline (point target scene → raw data → verify phase) in `tests/integration/test_simulation_pipeline.py`

### Implementation for User Story 1

- [ ] T032 [P] [US1] Implement PointTarget (position, rcs, velocity) in `pySimSAR/core/scene.py`
- [ ] T033 [P] [US1] Implement DistributedTarget (grid, reflectivity, scattering_matrix, elevation, clutter_model) in `pySimSAR/core/scene.py`
- [ ] T034 [P] [US1] Implement Scene (origin, target collections, add_target) in `pySimSAR/core/scene.py`
- [ ] T035 [P] [US1] Implement UniformClutter in `pySimSAR/clutter/uniform.py`
- [ ] T036 [P] [US1] Implement AntennaPattern (2D pattern lookup, gain calculation) in `pySimSAR/core/radar.py`
- [ ] T037 [US1] Implement Radar (carrier_freq, prf, power, noise_figure, system_losses, ref_temp, look_side, depression_angle, squint_angle, derived properties) in `pySimSAR/core/radar.py`
- [ ] T038 [US1] Implement LFMWaveform (chirp generation, matched filter range compression) in `pySimSAR/waveforms/lfm.py`
- [ ] T039 [US1] Implement FMCWWaveform (up/down/triangle ramps, duty cycle, dechirp + FFT range compression) in `pySimSAR/waveforms/fmcw.py`
- [ ] T040 [US1] Implement CompositePSDPhaseNoise (multi-slope PSD generation, frequency shaping, IFFT) in `pySimSAR/waveforms/phase_noise.py`
- [ ] T041 [US1] Implement antenna beam modeling for stripmap mode (fixed broadside/squint direction, two-way gain computation) in `pySimSAR/simulation/antenna.py`
- [ ] T042 [US1] Implement spotlight beam steering (per-pulse antenna pointing to track fixed scene center, wider Doppler bandwidth handling) in `pySimSAR/simulation/antenna.py`
- [ ] T043 [US1] Implement scan-SAR beam steering (cyclic elevation sweep across sub-swaths, burst-mode pulse scheduling, scalloping modeling) in `pySimSAR/simulation/antenna.py`
- [ ] T044 [US1] Implement echo signal computation (per-target echo with radar range equation, phase noise, target velocity, R⁴ path loss, mode-aware beam direction per pulse) in `pySimSAR/simulation/signal.py`
- [ ] T045 [US1] Implement SimulationEngine orchestrator (pulse loop, target summation, receiver noise, polarimetric channels, SAR mode dispatch) in `pySimSAR/simulation/engine.py`
- [ ] T046 [US1] Implement SimulationConfig (validation, state transitions) in `pySimSAR/io/config.py`
...
- [ ] T047 [P] [US2] Unit test for Platform (nominal path generation) in `tests/unit/test_platform.py`
- [ ] T048 [P] [US2] Unit test for DrydenTurbulence (spectral characteristics) in `tests/unit/test_platform.py`
- [ ] T049 [P] [US2] Unit test for Trajectory (ideal vs perturbed generation) in `tests/unit/test_platform.py`
- [ ] T050 [P] [US2] Unit test for GaussianGPSError (RMS accuracy, outage handling) in `tests/unit/test_gps.py`
- [ ] T051 [P] [US2] Unit test for WhiteNoiseIMUError (noise density matching) in `tests/unit/test_imu.py`

### Implementation for User Story 2

- [ ] T052 [P] [US2] Implement Platform (velocity, altitude, heading, start_position, sensor attachment) in `pySimSAR/core/platform.py`
- [ ] T053 [P] [US2] Implement Trajectory (time, position, velocity, attitude arrays) in `pySimSAR/motion/trajectory.py`
- [ ] T054 [US2] Implement ideal trajectory generation (straight-line from Platform params) in `pySimSAR/motion/trajectory.py`
- [ ] T055 [US2] Implement MotionPerturbation and DrydenTurbulence (MIL-HDBK-1797 transfer functions, white noise filtering) in `pySimSAR/motion/perturbation.py`
- [ ] T056 [US2] Implement perturbed trajectory generation (ideal + perturbation → true trajectory) in `pySimSAR/motion/trajectory.py`
- [ ] T057 [P] [US2] Implement GPSSensor config and GaussianGPSError (additive Gaussian noise, outage intervals) in `pySimSAR/sensors/gps.py` and `pySimSAR/sensors/gps_gaussian.py`
- [ ] T058 [P] [US2] Implement IMUSensor config and WhiteNoiseIMUError (additive white noise on accel/gyro) in `pySimSAR/sensors/imu.py` and `pySimSAR/sensors/imu_white_noise.py`
- [ ] T059 [US2] Implement NavigationData generation (sensors sample true trajectory → noisy measurements) in `pySimSAR/sensors/gps.py` and `pySimSAR/sensors/imu.py`
- [ ] T060 [US2] Integrate motion and sensors with SimulationEngine (perturbed trajectory used for echo computation, nav data stored in result) in `pySimSAR/simulation/engine.py`
...
- [ ] T061 [P] [US3] Unit test for HDF5 write/read of RawData in `tests/unit/test_io.py`
- [ ] T062 [P] [US3] Unit test for HDF5 write/read of NavigationData and Trajectory in `tests/unit/test_io.py`
- [ ] T063 [P] [US3] Unit test for HDF5 write/read of SARImage in `tests/unit/test_io.py`
- [ ] T064 [P] [US3] Unit test for SimulationConfig and ProcessingConfig JSON serialization in `tests/unit/test_io.py`
- [ ] T065 [US3] Contract test for data format (round-trip fidelity, metadata completeness) in `tests/contract/test_data_format.py`

### Implementation for User Story 3

- [ ] T066 [US3] Implement RawData entity (echo matrix, channel, sample_rate, radar/trajectory refs) in `pySimSAR/core/types.py`
- [ ] T067 [US3] Implement NavigationData entity in `pySimSAR/core/types.py`
- [ ] T068 [US3] Implement PhaseHistoryData entity in `pySimSAR/core/types.py`
- [ ] T069 [US3] Implement SARImage entity in `pySimSAR/core/types.py`
- [ ] T070 [US3] Implement HDF5 writer (raw_data, navigation, trajectory, images, config groups per data-format contract) in `pySimSAR/io/hdf5_format.py`
- [ ] T071 [US3] Implement HDF5 reader (load any data type from HDF5, reconstruct entities) in `pySimSAR/io/hdf5_format.py`
- [ ] T072 [US3] Implement ProcessingConfig entity and JSON serialization in `pySimSAR/io/config.py`
- [ ] T073 [US3] Implement SimulationConfig JSON serialization in `pySimSAR/io/config.py`
- [ ] T074 [US3] Add save/load convenience methods to RawData, SARImage, and SimulationResult in `pySimSAR/core/types.py`
...
- [ ] T075 [P] [US4] Integration test for Range-Doppler algorithm (point target impulse response) in `tests/integration/test_image_formation.py`
- [ ] T076 [P] [US4] Integration test for Chirp Scaling algorithm in `tests/integration/test_image_formation.py`
- [ ] T077 [P] [US4] Integration test for Omega-K algorithm in `tests/integration/test_image_formation.py`
- [ ] T078 [US4] Integration test for two-step interface (range_compress → PhaseHistoryData → azimuth_compress) in `tests/integration/test_image_formation.py`

### Implementation for User Story 4

- [ ] T079 [US4] Implement Range-Doppler algorithm (range_compress, azimuth_compress, process, supported_modes) in `pySimSAR/algorithms/image_formation/range_doppler.py`
- [ ] T080 [US4] Implement Chirp Scaling algorithm in `pySimSAR/algorithms/image_formation/chirp_scaling.py`
- [ ] T081 [US4] Implement Omega-K algorithm (Stolt interpolation) in `pySimSAR/algorithms/image_formation/omega_k.py`
- [ ] T082 [US4] Register all image formation algorithms in `pySimSAR/algorithms/image_formation/__init__.py`
