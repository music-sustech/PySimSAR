...
Usage:
    python examples/golden/single_point_stripmap/plot.py [--show]
...
def main():
    ...
    print("  Saved: plot2_range_compressed.png")
    ...
    print("  Saved: plot3_focused_image.png")
    ...
    print("  Saved: plot4_5_impulse_response.png")
