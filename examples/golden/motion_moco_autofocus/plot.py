...
Usage:
    python examples/golden/motion_moco_autofocus/plot.py [--show]
...
def main():
    ...
    print("  Saved: plot1_trajectory.png")
    ...
    print("  Saved: plot2_position_error.png")
    ...
    print("  Saved: plot3_image_comparison.png")
    ...
    print("  Saved: plot4_azimuth_cuts.png")
    ...
    print("  Saved: plot5_phase_error.png")
    ...
    print(f"  Max phase error: {max_phase_err:.1f} rad ({max_phase_err/(2*np.pi):.1f} cycles)")
